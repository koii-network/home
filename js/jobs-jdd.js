function option10() {
    ...
    active.classList.add("active");
      ...
      <div class="job-green">About the Role: <spam class="job-line">Jr. DevOps Developer</spam></div>
      <div class="job-detail">
      ...
      <div class="job-detail">
        <ul>
       <li>1-2 Years of Infrastructure Management Experience
       <li>Continuous Delivery and Integration
       <li>Kubernetes and Docker Experience
       <li>An understanding of the AWS Console and Stack
       <li>Interest in serverless technology
      ...
      <ul>
        ...
        <li>Link to your portfolio/GitHub for any past projects relevant to this role.</li>
      </ul>
      </div>
      <a>
